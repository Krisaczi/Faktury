  ...
  return (
    <TooltipProvider>
      <Stack gap="5" className="max-w-7xl">
        ...
        <PageHeader
          title="Raport ryzyka"
          description="Analiza poziomów ryzyka Twoich faktur."
        >
          <Button
            onClick={() => exportCsv({
          ...
          <CardContent className="pt-4 pb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Wyszukaj po numerze faktury lub nazwie firmy…"
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <CardDescription>
                    {isLoading ? 'Wczytywanie…' : `Liczba faktur ${data?.totalCount ?? 0}`}
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              <table className="w-full text-sm" aria-label="Invoice risk report" aria-busy={isLoading}>
                <thead>
                  <tr className="border-b border-slate-100 dark:border-slate-800">
                    {[
                      { label: 'Numer',  field: null,         w: 'w-40' },
                      { label: 'Dostawca',     field: null,         w: '' },
                      { label: 'Ryzyko',       field: null,         w: 'w-24' },
                      { label: 'Data faktury', field: 'issue_date', w: 'w-28' },
                      { label: 'Kwota',     field: 'amount',     w: 'w-28 text-right' },
                      { label: 'Poziom ryzyka',      field: null,         w: 'w-16 text-center' },
                      { label: 'Działania',    field: null,         w: 'w-20 text-center' },
                    ].map(({ label, field, w }) => (
