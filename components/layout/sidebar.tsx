            ...
            <>
              ...
              {(effectiveRole === 'owner') && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    {(() => {
                      const active = pathname.startsWith('/admin/contact-messages');
                      return (
                        <Link
                        ...
                        >
                          ...
                          />
                          {!collapsed && <span>Wiadomości</span>}
                          {!collapsed && active && (
                            <span className="ml-auto w-1.5 h-1.5 rounded-full bg-white/60" />
                          )}
                        </Link>
              ...
              {/* Zdarzenia klientów — owner only */}
              {(effectiveRole === 'owner') && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    {(() => {
                      const active = pathname.startsWith('/admin/customer-audit');
                      return (
                        <Link
                          href="/admin/customer-audit"
                          className={cn(
                            'flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 group',
                            active
                              ? 'bg-blue-600 text-white shadow-sm shadow-blue-600/30'
                        ...
                        >
                          ...
                          />
                          {!collapsed && <span>Zdarzenia klientów</span>}
                          {!collapsed && active && (
                            <span className="ml-auto w-1.5 h-1.5 rounded-full bg-white/60" />
                          )}
                        </Link>
              ...
              {/* Zdarzenia e-mail — owner only */}
              {(effectiveRole === 'owner') && (
                <Tooltip>
                  <TooltipTrigger asChild>
                    {(() => {
                      const active = pathname.startsWith('/admin/email-events');
                      return (
                        <Link
                        ...
                        >
                          ...
                          />
                          {!collapsed && <span>Zdarzenia e-mail</span>}
                          {!collapsed && active && (
                            <span className="ml-auto w-1.5 h-1.5 rounded-full bg-white/60" />
                          )}
                        </Link>
